...
<div class="fdb-block bg-gold py-3 mb-3">
	...
	<a class="col-1 mx-auto text-center" href="#">
		<img class="w-75" src="<?php bloginfo('template_url'); ?>/svg/draft.svg"/><span class="fw-bold fs-5 text-dark">Drafts</span></a>
	<a class="col-1 mx-auto text-center" href="#">
		<img class="w-75" src="<?php bloginfo('template_url'); ?>/svg/inking.svg"/><span class="fw-bold fs-5 text-dark">Inkings</span></a>
