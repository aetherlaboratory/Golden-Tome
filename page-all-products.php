...
<a class="col-1 mx-auto text-center" href="#">
	<img class="w-75" src="<?php bloginfo('template_url'); ?>/svg/good.svg"/><span class="fw-bold fs-5 text-dark">Good</span></a>
<a class="col-1 mx-auto text-center" href="#">
	<img class="w-75" src="<?php bloginfo('template_url'); ?>/svg/bad.svg"/><span class="fw-bold fs-5 text-dark">Villains</span></a>
<a class="col-1 mx-auto text-center" href="#">
	<img class="w-75" src="<?php bloginfo('template_url'); ?>/svg/side.svg"/><span class="fw-bold fs-5 text-dark">Side</span></a>
<a class="col-1 mx-auto text-center" href="#">
	<img class="w-75" src="<?php bloginfo('template_url'); ?>/svg/evil.svg"/><span class="fw-bold fs-5 text-dark">Creatures</span></a>
</div><!-- row -->
</div>
*/
?>
...
<div class="card col-10 col-md-6 col-lg-3 mx-auto">
...
echo wc_price( wc_get_price_to_display( $product ) );?></h4>
<div class="caption"><?php echo wp_trim_words( get_the_excerpt(), 20 ); ?></div></div>
