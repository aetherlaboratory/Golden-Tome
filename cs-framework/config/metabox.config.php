...
// -----------------------------------------
// Character Post Metabox Options                    -
// -----------------------------------------
$options[]    = array(
  'id'        => 'character_post_options',
  'title'     => 'Custom Post Options',
  'post_type' => 'character',
  'context'   => 'normal',
  'priority'  => 'default',
    ...
    array(
      ...
      'fields' => array(
        ...
        array(
          ...
          'title'   => 'Age',
          'default' => '10',
          'after'   => ' <i class="cs-text-muted">Human Years</i>',
        ),
        ...
        array(
          ...
          'title'     => 'Gender',
          'options'   => array(
            'value-1' => get_template_directory_uri() . '/cs-framework/assets/images/male.png',
            'value-2' => get_template_directory_uri() . '/cs-framework/assets/images/female.png',
            'value-3' => get_template_directory_uri() . '/cs-framework/assets/images/fluid.png',
            'value-4' => get_template_directory_uri() . '/cs-framework/assets/images/androgyne.png',
          ),
        ),

        
        array(
          'id'          => 'additional_chara_img',
          'type'        => 'gallery',
          'title'       => 'Additional Character Images',
          'desc'        => 'Additional Images for Character.',
          'help'        => 'Try to use images with different angles/context.',
