...
<div class="fdb-block bg-gold py-3 mb-3">
	...
	<a class="col-1 mx-auto text-center" href="#">
		<img class="w-75" src="<?php bloginfo('template_url'); ?>/svg/weapons.svg"/><span class="fw-bold fs-5 text-dark">Weapons</span></a>
	<a class="col-1 mx-auto text-center" href="#">
		<img class="w-75" src="<?php bloginfo('template_url'); ?>/svg/items.svg"/><span class="fw-bold fs-5 text-dark">Items</span></a>
<a class="col-1 mx-auto text-center" href="#">
	<img class="w-75" src="<?php bloginfo('template_url'); ?>/svg/vehicle.svg"/><span class="fw-bold fs-5 text-dark">Vehicles</span></a>
