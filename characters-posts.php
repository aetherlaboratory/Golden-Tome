...
function character_post_type() {
	...
	$labels = array(
		...
		'add_new_item'          => __( 'Add New Character', 'text_domain' ),
		...
		'view_items'            => __( 'View Characters', 'text_domain' ),
	...
	$args = array(
		...
		'description'           => __( 'Character videos, gif loops, and keyframes', 'text_domain' ),
		'labels'                => $labels,
